      ...
      <div className="max-w-screen-xl mx-auto px-8">
        ...
        <div className="flex gap-16 mb-16">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={item.label}>
                  <Link to={item.to} className="font-['Poltawski_Nowy',serif] text-white/80 text-sm hover:text-white transition-colors">{item.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/contact" className="font-['Poltawski_Nowy',serif] text-white/80 text-sm hover:text-white transition-colors">Contact Us</Link>
              </li>
              <li>
                <a href="#" className="font-['Poltawski_Nowy',serif] text-white/80 text-sm hover:text-white transition-colors">Address</a>
              </li>
            </ul>
          </div>
