    ...
    <nav className="w-full bg-[#fff4f8] border-b-2 border-black sticky top-0 z-50">
      <div className="max-w-screen-xl mx-auto px-8 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-10">
          <a href="#" className="font-['Poltawski_Nowy',serif] text-sm tracking-widest text-black hover:opacity-70 transition-opacity">HOME</a>
          <a href="#" className="font-['Poltawski_Nowy',serif] text-sm tracking-widest text-black hover:opacity-70 transition-opacity">SHOP</a>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="ml-4 flex items-center gap-2 bg-black text-white rounded-full px-6 py-2 hover:bg-gray-900 transition-colors">
